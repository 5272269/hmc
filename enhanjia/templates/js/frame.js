...
// 		$(".sidebar-collapse .upbtn").click(function(){
// 			if($("#index_menu2").attr("class")=="index_menu2 showmenu"){
// 				$("#index_menu2").attr("class","index_menu2 hidemenu");
// 			}else{
// 				$("#index_menu2").attr("class","index_menu2 showmenu");
// 			}
// 		});
// 	}
