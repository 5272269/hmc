...
;(function($){
	$.fn.jcDate = function(options) {
		...
		return this.each(function() {
			if($("#jcDate").length == 0){
				$("body").prepend("<div id='jcDate'><input type='hidden' value='' id='dateHideText' /><div id='jcDateTt'><a id='d_prev'></a><div><span></span><b>Year</b><samp></samp><b>Month</b></div><a id='d_next'></a></div><dl id='jcYeas'></dl><dl id='jcMonth'></dl><div id='jcDayWrap'><dl id='jcDayCon'></dl><div id='jcDateMax'><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul></div><div id='jcDateBtn'><samp>TODAY</samp><span>CLEAR</span><a id='d_sub'>CONFIRM</a><div id='jcTimeWrap'><input type='text' value='' /><label>:</label><input type='text' value='' /></div></div></div></div>");
			};
            ...
            var $dateInput = $(this),
				 ...
				 weekDl = "",
				 yearDl = "<dd class='visited'>"+_year+"Year"+"</dd>",
				 monthDl = "",
				 $ul = "",
				 _idx = 0,
				 defInfo = "",
			...
			var NowY = _year,
				yArr = new Array(),
				mArr = new Array();
			for(var lys = 0; lys < 65 ; lys++ ){
				lastyear = NowY - (lys+1);
				yArr.push("<dt>"+lastyear+"Year"+"</dt>")
			};
		    yArr.reverse();
			var dtf = ysArr(yArr);
            yArr.length = 0;
			for(var fys = 0; fys < 8 ; fys++ ){
				...
				yArr.push("<dt>"+firstyear+"Year"+"</dt>")
			};
			var dtl = ysArr(yArr);
			...
			function mAnimate(index){
				...
				$month.text(index+1);
				$jcDateMax.animate({ "left":-index*513 },options.Speed);
			};
